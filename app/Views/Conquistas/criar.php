    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Nova Conquista</li>
            </ol>
        </nav>
    </div>
</div>
...
<div class="card">
    <div class="card-header">
        <h5 class="mb-0"><i class="bx bx-trophy me-2"></i>Nova Conquista</h5>
    </div>
    <div class="card-body">
        <form id="formConquista" action="<?php echo site_url('conquistas-admin/cadastrar'); ?>" method="post">
            <?php echo csrf_field(); ?>
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary">
                    <i class="bx bx-save me-2"></i>Salvar Conquista
                </button>
