...
<div class="page-breadcrumb d-sm-flex align-items-center mb-3">
    ...
    <div class="ms-auto">
        <a href="<?php echo site_url("agentes/exibir/{$agente->id}"); ?>" class="btn btn-secondary">
...
<div class="card shadow radius-10">
    ...
    <div class="card-body">
        <form id="formAgente" method="post" action="<?php echo site_url('agentes/atualizar'); ?>">
            ...
            <div class="d-flex justify-content-end">
                <a href="<?php echo site_url("agentes/exibir/{$agente->id}"); ?>" class="btn btn-light me-2">Cancelar</a>
