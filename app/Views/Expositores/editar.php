        ...
        <div class="card shadow radius-10">
            <div class="card-header">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="card-title mb-0">Editando Expositor</h5>
...
$(document).ready(function() {
    ...
    $("#form").on('submit', function(e) {
        ...
        $.ajax({
            ...
            type: 'POST',
            url: '<?php echo site_url('expositores/atualizar'); ?>',
            ...
            success: function(response) {
                ...
                if (!response.erro) {
                    ...
                    if (response.info) {
                        ...
                        window.location.href = "<?php echo site_url("expositores/exibir/$expositor->id"); ?>";
