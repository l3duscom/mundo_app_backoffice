    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item"><a href="<?php echo site_url("expositores/exibir/$expositor->id") ?>"><?= esc($expositor->getNomeExibicao()); ?></a></li>
        ...
        <div class="card shadow radius-10 border-danger border-start border-0 border-4">
            <div class="card-body">
                ...
                <div class="alert alert-warning" role="alert">
                    ...
                    <strong>Atenção!</strong> Você está prestes a excluir o expositor:
                </div>
                
                <div class="bg-light p-3 rounded mb-4">
                    <div class="row g-3">
                        <div class="col-12">
                            <strong><i class="bx <?php echo $expositor->isPessoaJuridica() ? 'bx-buildings' : 'bx-user'; ?> me-2"></i><?php echo esc($expositor->getNomeExibicao()); ?></strong>
                        </div>
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            ...
                            <p class="mb-0"><?php echo $expositor->getTipoPessoaFormatado(); ?></p>
                        </div>
                    </div>
                </div>

                <?php echo form_open("expositores/excluir/$expositor->id") ?>
                
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-danger">
                        <i class="bx bx-trash me-2"></i>Sim, excluir expositor
                    </button>
                    <a href="<?php echo site_url("expositores/exibir/$expositor->id") ?>" class="btn btn-secondary">
