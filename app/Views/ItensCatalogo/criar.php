...
<div class="row">
    <div class="col-xl-9 mx-auto">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form id="formItem" action="<?php echo site_url("itenscatalogo/cadastrar"); ?>">
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <button type="submit" class="btn btn-primary px-4">
                                <i class="bx bx-save me-1"></i>Cadastrar
                            </button>
    ...
    $('#formItem').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (!response.erro) {
                    window.location.href = "<?php echo site_url("itenscatalogo"); ?>";
                }
