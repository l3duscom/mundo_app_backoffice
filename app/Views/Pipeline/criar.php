    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Novo Lead</li>
            </ol>
        </nav>
    </div>
</div>
...
<form action="<?php echo site_url('pipeline/cadastrar'); ?>" method="post" id="formLead">
    <?php echo csrf_field(); ?>
    ...
    <div class="row">
        <div class="col-lg-8">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" 
                               name="nome_fantasia" 
                               class="form-control" 
                               value="<?php echo old('nome_fantasia'); ?>">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <select name="tipo_pessoa" class="form-select" id="tipoPessoa">
                            ...
                            <option value="fisica" <?php echo old('tipo_pessoa') === 'fisica' ? 'selected' : ''; ?>>Pessoa Física</option>
                        </select>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="origem" class="form-select">
                            ...
                            <option value="Indicação" <?php echo old('origem') === 'Indicação' ? 'selected' : ''; ?>>Indicação</option>
                            <option value="Site" <?php echo old('origem') === 'Site' ? 'selected' : ''; ?>>Site</option>
                            <option value="Instagram" <?php echo old('origem') === 'Instagram' ? 'selected' : ''; ?>>Instagram</option>
                            <option value="Evento anterior" <?php echo old('origem') === 'Evento anterior' ? 'selected' : ''; ?>>Evento anterior</option>
                            <option value="WhatsApp" <?php echo old('origem') === 'WhatsApp' ? 'selected' : ''; ?>>WhatsApp</option>
                            <option value="E-mail" <?php echo old('origem') === 'E-mail' ? 'selected' : ''; ?>>E-mail</option>
                            <option value="Prospecção" <?php echo old('origem') === 'Prospecção' ? 'selected' : ''; ?>>Prospecção</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="form-card">
                ...
                <textarea name="observacoes" class="form-control" rows="4" placeholder="Anotações sobre o lead..."><?php echo old('observacoes'); ?></textarea>
            </div>
        </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="form-card">
                ...
                <div class="mb-4">
                    ...
                    <div class="temperatura-selector">
                        <input type="radio" class="btn-check" name="temperatura" id="tempFrio" value="frio" <?php echo old('temperatura', 'frio') === 'frio' ? 'checked' : ''; ?>>
                        <label class="btn btn-temperatura-frio" for="tempFrio">
                            <i class="bx bx-wind"></i> Frio
                        </label>
                        
                        <input type="radio" class="btn-check" name="temperatura" id="tempMorno" value="morno" <?php echo old('temperatura') === 'morno' ? 'checked' : ''; ?>>
                        <label class="btn btn-temperatura-morno" for="tempMorno">
                            <i class="bx bx-sun"></i> Morno
                        </label>
                        
                        <input type="radio" class="btn-check" name="temperatura" id="tempQuente" value="quente" <?php echo old('temperatura') === 'quente' ? 'checked' : ''; ?>>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" 
                               ...
                               value="<?php echo old('valor_estimado'); ?>"
                               placeholder="0,00">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="date" 
                           name="proxima_acao" 
                           class="form-control" 
                           value="<?php echo old('proxima_acao'); ?>">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" 
                           ...
                           class="form-control" 
                           value="<?php echo old('proxima_acao_descricao'); ?>"
                ...
                <div class="mb-3">
                    ...
                    <select name="vendedor_id" class="form-select">
                        ...
                        <?php foreach ($vendedores as $vendedor): ?>
                            <option value="<?php echo $vendedor['id']; ?>" <?php echo old('vendedor_id') == $vendedor['id'] ? 'selected' : ''; ?>>
                ...
                <div class="mb-3">
                    ...
                    <select name="evento_id" class="form-select">
                        ...
                        <?php foreach ($eventos as $evento): ?>
                            <option value="<?php echo $evento['id']; ?>" <?php echo old('evento_id') == $evento['id'] ? 'selected' : ''; ?>>
            ...
            <div class="d-grid gap-2">
                <button type="submit" class="btn btn-primary btn-lg">
                    <i class="bx bx-save me-2"></i>Cadastrar Lead
                </button>
                <a href="<?php echo site_url('pipeline'); ?>" class="btn btn-outline-secondary">
