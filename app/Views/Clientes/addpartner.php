    ...
    <div class="col-lg-8">
        ...
        <div class="block">
            ...
            <div class="block-body">
                ...
                <?php echo $this->include('Clientes/_form_partner'); ?>
                ...
                <div class="form-group mt-5 mb-2">
                    ...
                    <a href="<?php echo site_url("clientes/parceiros") ?>" class="btn btn-secondary btn-sm ml-2">Voltar</a>
    ...
    $(document).ready(function() {
        ...
        $("#form").on('submit', function(e) {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: '<?php echo site_url('clientes/cadastrarPartner'); ?>',
