...
<p style="font-size: 12px; color: #6b7280;">Seus produtos ficam disponíveis em <a href="https://mundodream.com.br/console/dashboard">sua área de membros</a>, na aba "Meus Produtos" após a confirmação do pagamento.</p>
<?php endif; ?>
