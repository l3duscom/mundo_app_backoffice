...
<div class="card shadow radius-10">
    <div class="card-header">
        <h5 class="mb-0"><i class="bx bx-user-plus me-2"></i><?php echo $titulo; ?></h5>
    </div>
    <div class="card-body">
        <form id="formArtista" method="post" action="<?php echo site_url('artistas/cadastrar'); ?>">
            ...
            <div class="d-flex justify-content-end">
                <a href="<?php echo site_url('artistas'); ?>" class="btn btn-light me-2">Cancelar</a>
                <button type="submit" class="btn btn-primary">
                    <i class="bx bx-save me-2"></i>Salvar Artista
                </button>
            </div>
        </form>
    </div>
...
$(document).ready(function() {
    ...
    $('#formArtista').on('submit', function(e) {
        ...
        $.ajax({
            url: '<?php echo site_url("artistas/cadastrar"); ?>',
            type: 'POST',
            data: form.serialize(),
            dataType: 'json',
            success: function(response) {
                ...
                if (response.erro) {
                    alert(response.erro);
                    btn.prop('disabled', false).html('<i class="bx bx-save me-2"></i>Salvar Artista');
                    return;
                }
