...
<div class="card">
    <div class="card-header">
        <h6 class="mb-0"><i class="bx bx-purchase-tag-alt me-2"></i>Novo Cupom de Desconto</h6>
    </div>
    <div class="card-body">
        <?php echo form_open('/', ['id' => 'formCupom', 'class' => 'row g-3'], ['id' => '']); ?>
            ...
            <div class="col-12">
                ...
                <button type="submit" class="btn btn-primary" id="btn-salvar">
                    <i class="bx bx-save me-1"></i>Cadastrar Cupom
                </button>
            </div>
...
$(document).ready(function() {
    ...
    $("#formCupom").on('submit', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('cupons/cadastrar'); ?>",
            ...
            success: function(response) {
                $("#btn-salvar").prop("disabled", false).html('<i class="bx bx-save me-1"></i>Cadastrar Cupom');
