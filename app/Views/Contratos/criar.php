...
<div class="page-breadcrumb d-sm-flex align-items-center mb-3">
    ...
    <div class="ms-auto">
        <div class="btn-group">
            ...
            <a href="<?php echo site_url("contratos") ?>" class="btn btn-secondary">
        ...
        <div class="card shadow radius-10">
            <div class="card-header">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="card-title mb-0">Novo Contrato</h5>
                        <small class="text-muted">Preencha os dados do contrato</small>
                    </div>
                </div>
            </div>
...
$(document).ready(function() {
    ...
    $("#form").on('submit', function(e) {
        ...
        $.ajax({
            ...
            type: 'POST',
            url: '<?php echo site_url('contratos/cadastrar'); ?>',
            ...
            success: function(response) {
                ...
                if (!response.erro) {
                    ...
                    if (response.info) {
                        ...
                        window.location.href = "<?php echo site_url("contratos/exibir/"); ?>" + response.id;
