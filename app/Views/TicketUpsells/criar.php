...
<div class="card shadow radius-10">
    <div class="card-header">
        <h5 class="mb-0"><i class="bx bx-trending-up me-2"></i><?php echo $titulo; ?></h5>
    </div>
    <div class="card-body">
        <form id="formUpsell" method="post" action="<?php echo site_url('ticket-upsells/cadastrar'); ?>">
            ...
            <div class="d-flex justify-content-end">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="bx bx-save me-2"></i>Salvar Upsell
                </button>
            </div>
        </form>
    </div>
...
$(document).ready(function() {
    ...
    // Calcula inicial se já tem valores
    if ($('#ticketOrigem').val() && $('#ticketDestino').val()) {
        calcularDiferenca();
    }
    ...
    $('#formUpsell').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.erro) {
                    alert(response.erro);
                    btn.prop('disabled', false).html('<i class="bx bx-save me-2"></i>Salvar Upsell');
                    return;
                }
