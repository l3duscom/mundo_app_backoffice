...
<div class="card shadow radius-10">
    ...
    <div class="card-body">
        <form id="formOrderBump" method="post" action="<?php echo site_url('order-bumps/atualizar'); ?>" enctype="multipart/form-data">
            ...
            <div class="d-flex justify-content-end">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="bx bx-save me-2"></i>Atualizar Order Bump
                </button>
            </div>
        </form>
    </div>
...
$(document).ready(function() {
    ...
    $('#btnRemoverImagem').click(function() {
        ...
        $.post('<?php echo site_url("order-bumps/removerImagem"); ?>', {
            '<?php echo csrf_token(); ?>': '<?php echo csrf_hash(); ?>',
            'id': '<?php echo $orderBump->id; ?>'
        }, function(r) {
            ...
            $('#imagemPreview').html('<i class="bx bx-image text-muted" style="font-size: 3rem;"></i>');
            btn.remove();
        }, 'json');
    });
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.erro) {
                    ...
                    btn.prop('disabled', false).html('<i class="bx bx-save me-2"></i>Atualizar Order Bump');
                    return;
                }
