# Configuração de Projeto Gemini

Este arquivo ajuda o Gemini a entender as especificidades deste projeto.
...
*   Gerenciamento de clientes e usuários com permissões baseadas em papéis
...
*   **Objetivo Principal:** Auxiliar no desenvolvimento de novas funcionalidades, na correção de bugs e na refatoração de código, sempre aderindo aos padrões e convenções já estabelecidos no projeto.
*   **Tom:** Técnico, direto e em português.
...
*   A aplicação roda do diretório `public/` (document root)
